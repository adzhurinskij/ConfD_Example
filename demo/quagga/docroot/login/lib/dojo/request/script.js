...
//>>built
define("dojo/request/script","module ./watch ./util ../_base/kernel ../_base/array ../_base/lang ../on ../dom ../dom-construct ../has ../_base/window".split(" "),function(n,p,h,q,r,s,t,u,v,l,w){function x(a,b){a.canDelete&&f._remove(a.id,b.options.frameDoc,!0)}function y(a){g&&g.length&&(r.forEach(g,function(a){f._remove(a.id,a.frameDoc);a.frameDoc=null}),g=[]);return a.options.jsonp?!a.data:!0}function z(a){return!!this.scriptLoaded}function A(a){return(a=a.options.checkString)&&eval("typeof("+a+
...
delete k[a])};f._callbacksProperty=m+"_callbacks";return f});
