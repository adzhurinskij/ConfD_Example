	...
	return declare("dijit.form._FormWidgetMixin", null, {
		...
		_onFocus: function(/*String*/ by){
			...
			if(by == "mouse" && this.isFocusable()){
				...
				if(this.__mouseUpHandle){
					this.__mouseUpHandle.remove();
				}
				if(this.__focusHandle){
					this.__focusHandle.remove();
				}
				delete this.__mouseUpHandle;
				delete this.__focusHandle;

				this.__focusHandle = this.own(on(this.focusNode, "focus", lang.hitch(function(){
					if(this.__mouseUpHandle){
						this.__mouseUpHandle.remove();
					}
					if(this.__focusHandle){
				...
				this.__mouseUpHandle = this.own(on(this.ownerDocumentBody, "mouseup, touchend", lang.hitch(this, function(evt){
					if(this.__mouseUpHandle){
						this.__mouseUpHandle.remove();
					}
					if(this.__focusHandle){
...
define(["./dom-geometry", "./_base/lang", "./domReady", "./sniff", "./_base/window"],
	...
	var
		...
		maj = Math.floor,
		ff = has("ff"),
		trident = !has("ie") && has("trident"), // Added by XWT to detect IE 11+ and set a CSS class
		...
		classes = {
			...
			"dj_trident": trident // Inject an IE+ specific class, added by XWT.
	...
	if(trident){
		// Added by XWT to handle IE 11 + specific CSS 
