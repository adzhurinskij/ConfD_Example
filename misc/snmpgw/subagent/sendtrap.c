...
int test2(struct confd_notification_ctx *nctx)
{
    ...
    OK(confd_notification_send_snmp(nctx, "notif2", &vb, 1));
    return 1;
}
...
{
  OK(confd_notification_send_snmp(nctx, "notif3", NULL, 0));
  return 1;
}
...
int test5(struct confd_notification_ctx *nctx)
{
    ...
    vb.type = CONFD_SNMP_COL_ROW;
    /* RowIndex = 6."saturn" */
    strcpy(vb.var.cr.column, "hostExtra");
    vb.var.cr.rowindex.oid[0] = 's';
    vb.var.cr.rowindex.oid[1] = 'a';
    vb.var.cr.rowindex.oid[2] = 't';
    vb.var.cr.rowindex.oid[3] = 'u';
    vb.var.cr.rowindex.oid[4] = 'r';
    vb.var.cr.rowindex.oid[5] = 'n';
    vb.var.cr.rowindex.len = 6;
    CONFD_SET_STR(&vb.val, "a string value");
    OK(confd_notification_send_snmp(nctx, "notif4", &vb, 1));
    return 1;
}
...
{
  OK(confd_notification_send_snmp(nctx, "extraNotif1", NULL, 0));
  return 1;
}
...
int test7(struct confd_notification_ctx *nctx)
{
  ...
  vb.var.cr.rowindex.len = 7;
  CONFD_SET_INT32(&vb.val, 987);
  OK(confd_notification_send_snmp(nctx, "extraNotif2", &vb, 1));
  return 1;
}
...
int test8(struct confd_notification_ctx *nctx)
{
  ...
  vb.type = CONFD_SNMP_COL_ROW;
  /* RowIndex = 6."saturn" */
  strcpy(vb.var.cr.column, "extraHostValue");
  vb.var.cr.rowindex.oid[0] = 6;
  vb.var.cr.rowindex.oid[1] = 's';
  vb.var.cr.rowindex.oid[2] = 'a';
  vb.var.cr.rowindex.oid[3] = 't';
  ...
  vb.var.cr.rowindex.oid[6] = 'n';
  vb.var.cr.rowindex.len = 7;
  CONFD_SET_STR(&vb.val, "extra variable value");
  OK(confd_notification_send_snmp(nctx, "extraNotif3", &vb, 1));
  return 1;
}
